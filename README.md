...
This code was written to run all spectral analyses at once rather than specific tests. It takes .mat files as input and produces figures, statistics and tables for time in state, spectral power, bout analysis, etc. Only the time in state analysis was reported in this paper. For more information see https://github.com/PeixotoLab/MeCP2Z and the corresponding paper (Al Maghribi et al., 2025). 
