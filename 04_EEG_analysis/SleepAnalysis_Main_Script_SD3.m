...
% S = InputParams_p24_p30_for_spectra;
S = InputParamsCAITLIN_all_notforspectra_p24;
%S = InputParamsCAITLIN_all_notforspectra_p30;
...
% Males
[Twelve_hour_avg.percentages.(Sexes{1}),HourlyStatePercentages.(Sexes{1}),RepMeas_ANOVA_tables.(Sexes{1}).hourly_percentage,~]     = Time_In_State_Analysis_SD3(TimeInState=TimeInState,Sex=Sexes{1},LegendLabels=LegendLabels,SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{1}).hourly_percentage.First12hrBL, rm_model_BL_LP] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[1 12], inBLorSD='BL',Sex=Sexes{1},SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{1}).hourly_percentage.Last12hrBL,  rm_model_BL_DP] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[13 24],inBLorSD='BL',Sex=Sexes{1},SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{1}).hourly_percentage.First12hrSD, rm_model_SD_LP] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[SD_length_hrs+1 12], inBLorSD='SD',Sex=Sexes{1},SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{1}).hourly_percentage.Last12hrSD,  rm_model_SD_DP] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[13 24], inBLorSD='SD',Sex=Sexes{1},SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{1}).hourly_percentage.First6hrDPBL,rm_mod_BL_DPf6] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[13 18], inBLorSD='BL',Sex=Sexes{1},SD_length_hrs=SD_length_hrs); % these 4 lines are for 6-hour segments during DP
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{1}).hourly_percentage.Last6hrDPBL, rm_mod_BL_DPl6] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[19 24], inBLorSD='BL',Sex=Sexes{1},SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{1}).hourly_percentage.First6hrDPSD,rm_mod_SD_DPf6] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[13 18], inBLorSD='SD',Sex=Sexes{1},SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{1}).hourly_percentage.Last6hrDPSD, rm_mod_SD_DPl6] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[19 24], inBLorSD='SD',Sex=Sexes{1},SD_length_hrs=SD_length_hrs);


% % Females
[Twelve_hour_avg.percentages.(Sexes{2}),HourlyStatePercentages.(Sexes{2}),RepMeas_ANOVA_tables.(Sexes{2}).hourly_percentage,~]       = Time_In_State_Analysis_SD3(TimeInState=TimeInState,Sex=Sexes{2},MakeFigures=0,LegendLabels=LegendLabels,SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{2}).hourly_percentage.First12hrBL,rm_model_F_BL_LP] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[1 12], inBLorSD='BL',Sex=Sexes{2},SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{2}).hourly_percentage.Last12hrBL, rm_model_F_BL_DP] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[13 24],inBLorSD='BL',Sex=Sexes{2},SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{2}).hourly_percentage.First12hrSD,rm_model_F_SD_LP] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[SD_length_hrs+1 12], inBLorSD='SD',Sex=Sexes{2},SD_length_hrs=SD_length_hrs);
[~,                               ~,                        RepMeas_ANOVA_tables.(Sexes{2}).hourly_percentage.Last12hrSD, rm_model_F_SD_DP] = Time_In_State_Analysis_SD3(TimeInState=TimeInState,TimeFrameRMANOVA=[13 24], inBLorSD='SD',Sex=Sexes{2},SD_length_hrs=SD_length_hrs);
