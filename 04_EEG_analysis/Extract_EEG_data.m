...
for anim=1:length(ffl_list)
	...
	EEG_FFT_table = EEG(:,colHzstart+3:44);	% the +3 is because there are 3 columns we are ignoring (and they are not in EEG_bin_edges): EpochNum, Stage, Time
